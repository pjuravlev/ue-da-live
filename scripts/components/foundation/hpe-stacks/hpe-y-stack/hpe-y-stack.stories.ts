...
const meta: Meta<StoryArgs> = {
  title: "Foundation/Stacks/Y Stack",
  component: "hpe-y-stack",
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
        component: "Y Stack is an HPE Web Design System component. Use these stories to explore its public API, variants, slots, and interaction behavior. Vertical stacks are used to arrange related items in a column with consistent spacing. Use gap variants to build predictable vertical rhythm.",
      },
    },
    layout: "fullscreen",
  },
